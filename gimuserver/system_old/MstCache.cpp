...
void MstCache::Load(const SystemConfig& cfg, const std::string& basePath)
...
static void LoadLoginCampaignMst(const std::string& path, Json::Value& res)
{
	...
	LoginCampaignMst loginMst;
	glz::read_file_json(loginMst, (path + "/logincompaign.json"), std::string{});
