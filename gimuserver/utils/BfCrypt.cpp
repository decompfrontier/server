...
* SREE AES key
*/
static constexpr const unsigned char kSreeKey[] = { 0x37, 0x34, 0x31, 0x30, 0x39, 0x35, 0x38, 0x31, 0x36, 0x34, 0x33, 0x35, 0x34, 0x38, 0x37, 0x31 }; // 7410958164354871

/*!
* SREE AES IV
*/
static constexpr const unsigned char kSreeIv[] = { 0x42, 0x66, 0x77, 0x34, 0x65, 0x6E, 0x63, 0x72, 0x79, 0x70, 0x65, 0x64, 0x50, 0x61, 0x73, 0x73 }; // Bfw4encrypedPass
...
std::optional<Sree> BfCrypt::BuildSREE(std::string_view input_json)
{
	try
	{
		...
		e.SetKeyWithIV(kSreeKey, sizeof(kSreeKey), kSreeIv);
