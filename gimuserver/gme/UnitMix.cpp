...
HANDLEF(UnitMix)
{
    ...
    // Incremental unit cache update.
    {
        ...
        ud.base_heal          = br["base_heal"].as<int32_t>();
        ud.add_heal           = br["add_heal"].as<int32_t>();
        ud.ext_heal           = br["ext_heal"].as<int32_t>();
        ud.limit_over_heal    = br["limit_over_heal"].as<int32_t>();
        ud.element            = br["element"].as<std::string>();
        ud.leader_skill_id    = br["leader_skill_id"].as<int32_t>();
        ud.skill_id           = br["skill_id"].as<int32_t>();
        ud.skill_lv           = br["skill_lv"].as<int32_t>();
        ud.extra_skill_id     = br["extra_skill_id"].as<int32_t>();
        ud.extra_skill_lv     = br["extra_skill_lv"].as<int32_t>();
